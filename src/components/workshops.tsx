    ...
    >
      <div className="flex justify-around items-center max-w-10xl px-6 py-2">
        <div className="flex flex-col justify-center items-center gap-4 w-full" data-aos="fade-up">
          <span className="text-[#ebc363] font-bold text-lg">
          ...
          <p className="text-lg text-center text-blue-900 max-w-4xl">
          ...
          <div className="flex flex-col gap-8 w-full max-w-4xl">
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-2 pt-4">
                <HiLightBulb className="w-10 h-10 text-blue-900" />

                <div className="bg-[#9db6cc] text-blue-900 font-semibold px-4 py-1 rounded-full">
          ...
          <div className="mt-8">
            <a href="#contact"
              className="inline-block bg-[#9db6cc] text-blue-900 font-semibold px-6 py-3 rounded-full shadow-lg

const Footer = () => {
  return (
    <footer id="contato" className="relative w-full bg-[#003366] text-white px-6 py-16 overflow-hidden">
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <h2 className="text-3xl md:text-4xl font-serif font-normal text-white leading-relaxed mb-8 max-w-4xl mx-auto">
        ...
        <button className="bg-[#F5F5DC] text-[#003366] font-bold px-10 py-4 rounded-full hover:scale-105 transition-transform mb-12">
          VAMOS CONVERSAR
        </button>

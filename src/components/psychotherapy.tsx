    ...
    >
      <div className="flex justify-around items-center max-w-8xl px-6 py-2">
        <div className="flex flex-col justify-center items-center gap-4 max-w-4xl" data-aos="fade-up">
          ...
          <span className="text-[#ebc363] font-bold text-lg">Psicoterapia</span>

          <h2 className="text-5xl font-serif font-bold text-[#003366] leading-tight">
            Como posso ajudar você
          </h2>

          <span className="text-lg text-center text-[#003366] max-w-2xl">
          ...
          <div className="flex justify-around items-start gap-15 pt-5">
            <div className="flex flex-col items-center gap-4 flex-1">
              <div className="bg-[#9db6cc] text-[#003366] font-semibold px-3 py-1 rounded-full flex items-center gap-2">
              ...
              <div className="flex flex-col gap-6 w-full">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Adolescentes (a partir de 14 anos)</h3>

                    <p className="text-sm text-justify text-[#003366] leading-normal">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Jovem Adulto</h3>

                    <p className="text-sm text-justify text-[#003366] leading-relaxed">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Adulto</h3>
            ...
            <div className="flex flex-col items-center gap-4 flex-1">
              ...
              <div className="flex flex-col gap-4 w-full">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Atendimento Presencial</h3>
                ...
                <div className="flex items-start gap-2 mt-12">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Atendimento Online</h3>
                ...
                <div className="flex items-start gap-2 mt-6">
                  ...
                  <div className="flex flex-col gap-1">
                    <h3 className="font-bold text-lg text-[#003366] text-start">Duração das sessões</h3>
